...
We — maintainers and contributors — pledge to make participation in
this project a harassment-free experience for everyone, regardless
...
- Focusing on what is best for the community and the user
- Showing empathy toward other community members
- Recognizing that this project deals with a sensitive topic
  (alcohol use), and that contributors may be working on it for
  personal reasons. Treat each other accordingly.

Examples of unacceptable behavior:

- Sexualized language or imagery, and sexual attention or advances
  of any kind
- Trolling, insulting/derogatory comments, and personal/political
  attacks
- Public or private harassment
- Publishing others' private information without explicit
  permission
- Using the issue tracker to shame, mock, or pressure individual
  users — or other apps' users
- Promoting alcohol use, alcohol marketing, or content that
  trivializes alcohol harm
...
may be reported by contacting the project team via the contact
listed in `SECURITY.md` (we use the same disclosure address for
conduct issues so reports go directly to a maintainer).
...
version 2.1, with project-specific additions for the alcohol-
sensitive context this project operates in.
